        ...
        <div>
            ...
            <Container>
                ...
                <Row style={{'padding-top': '10px', 'align': 'center'}}>
                    ...
                    <Col xs='6'><label>
                        <input type="text" value={this.state.value} onChange={this.handleRoleId} required/></label>
                    </Col>
                    <Col xs='3'></Col>
                </Row>
                <Row style={{'padding-top': '10px', 'align': 'center'}}>
                ...
                <Row style={{'padding-top': '10px', 'align': 'center'}}>
                    ...
                    <Col xs='6'><label>
                        <input type="text" value={this.state.value} onChange={this.handlePh1} required/></label>
                    </Col>
                    <Col xs='3'></Col>
                </Row>
                <Row style={{'padding-top': '10px', 'align': 'center'}}>
                    ...
                    <Col xs='6'><label>
                        <input type="text" value={this.state.value} onChange={this.handlePh2}/></label>
                    </Col>
                    <Col xs='3'></Col>
                </Row>
